	...
	void set_scores(int student_scores[])
	{
		for (int i = 0; i < 5; ++i)
		{
			if (student_scores[i] > 5)
				throw ExScore("in the function set_scores()", student_scores[i]);
...
int main()
{
	...
	{
		cout << "\nInicialization error of " << ex.funcName;
		cout << "\nIntered value of mark (" << ex.iValue << ") isn't allowed.";
	}
